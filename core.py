...
def pairx(device, imgs_0, imgs_1, model, layer_keys, k_lines, k_colors):
    ...
    for layer_key in layer_keys:
        ...
        coord_lists_1 = []
        all_matches = []
        for fm_0, fm_1, ir_0, ir_1 in zip(feature_map_0, feature_map_1, intermediate_relevance_0, intermediate_relevance_1):
...
def explain(imgs_0, imgs_1, imgs_np_0, imgs_np_1, model, layer_keys, k_lines=20, k_colors=10, background_opacity=0.2):
    ...
    for i, (img_np_0, img_np_1) in enumerate(zip(imgs_np_0, imgs_np_1)):
        ...
        for layer_key in layer_keys:
            ...
            intermediate_relevance_0, intermediate_relevance_1 = [ir[i] for ir in pairx_results[layer_key]["intermediate_relevances"]]
